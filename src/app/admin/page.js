    ...
    <div className="min-h-screen flex items-center justify-center bg-bg p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-primary mb-2">RouterDone</h1>
          <p className="text-text-muted">
            {authMode === "oidc" && oidcConfigured
              ? "Sign in with your OIDC provider to access the admin dashboard"
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {resetHint && (
                    <p className="text-xs text-text-muted">
                      Forgot password? Open <code className="bg-sidebar px-1 rounded">routerdone</code> CLI on the host - <b>Settings</b> - <b>Reset Password to Default</b>.
                    </p>
                  )}
                </div>
