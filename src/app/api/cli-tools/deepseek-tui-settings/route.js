...
const PROVIDER_NAME = "routerdone";
...
// Build TOML config for RouterDone (openai provider mode)
const buildRouterDoneConfig = (baseUrl, apiKey, model) => {
...
// Detect RouterDone by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildRouterDoneConfig(baseUrl, apiKey || "sk_routerdone", model);
