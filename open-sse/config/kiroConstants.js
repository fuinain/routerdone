 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what routerdone needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a routerdone
...
/**
 * Detect whether a model id refers to a routerdone synthetic agentic variant.
...
/**
 * Detect whether a model id is a routerdone synthetic thinking variant
...
/**
 * Resolve a routerdone model id to the real upstream Kiro model id, plus flags
