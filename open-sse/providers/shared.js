...
// Public OAuth client placeholders. Set your own IDs/secrets via env if you enable these providers.
export const ANTIGRAVITY_OAUTH_CLIENT = {
  clientId: process.env.ANTIGRAVITY_OAUTH_CLIENT_ID || "replace-with-antigravity-oauth-client-id",
  clientSecret: process.env.ANTIGRAVITY_OAUTH_CLIENT_SECRET || "replace-with-antigravity-oauth-client-secret"
};

export const GOOGLE_OAUTH_CLIENT = {
  clientId: process.env.GOOGLE_OAUTH_CLIENT_ID || "replace-with-google-oauth-client-id",
  clientSecret: process.env.GOOGLE_OAUTH_CLIENT_SECRET || "replace-with-google-oauth-client-secret"
};
