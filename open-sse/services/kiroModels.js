 ...
 * into routerdone-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are routerdone fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic routerdone variant set for a single upstream Kiro model.
 *
 ...
 * into routerdone variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
